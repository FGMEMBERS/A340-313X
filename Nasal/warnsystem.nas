...
#### takeoff config warnings ####
    takeoff_config_warnings : func
    {
        if (me.radio_alt<=30)
        {
           ...
           # 340: T/O warnings trigger when either throttle is at least at 0.667
           # 340: T/O warnings disabled after rotation with at lease 5 degrees nose-up
               ...
               (getprop("orientation/pitch-deg")<5))
           {
               ...
               # 340: The EICAS warning message CONFIG SPOILERS indicates
               ...
               # 340: Rudder trim must be within 2 units from center at T/O.
...
#### caution messages ####
    caution_messages : func
    {
        ...
        if (me.speedbrake)
        {
            # 349: EICAS caution message SPEEDBRAKE EXTENDED indicates
